...
![모달](https://lnwblzacktgzeiihvxtu.supabase.co/storage/v1/object/public/contents/prod/modal_wiki.png-159345)
...
const onClick = () => {
	open(({ isOpen, close }) => <FooConfirmDialog open={isOpen} onClose={close} />);
};
```

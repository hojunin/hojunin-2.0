...
오늘은 Apollo Graphql에서 소개된 **Resolver Chaining**이라는 개념으로 아키텍쳐를 변경해본 사례를 설명해볼게요.
...
![현재 그래프쿼리 구조](https://lnwblzacktgzeiihvxtu.supabase.co/storage/v1/object/public/contents/prod/1.png-74755)
...
![성능 체크](https://lnwblzacktgzeiihvxtu.supabase.co/storage/v1/object/public/contents/prod/2.png-280211)
...
![전](https://lnwblzacktgzeiihvxtu.supabase.co/storage/v1/object/public/contents/prod/3.png-356411)
join으로 한번에 긁어와서 이것저것 조합하여 내려주는 기본방식 - 22ms

![후](https://lnwblzacktgzeiihvxtu.supabase.co/storage/v1/object/public/contents/prod/4.png-371855)
...
![최종 결과](https://lnwblzacktgzeiihvxtu.supabase.co/storage/v1/object/public/contents/prod/5.png-388745)

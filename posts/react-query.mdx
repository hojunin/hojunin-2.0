...
![useQuery의 구조](https://lnwblzacktgzeiihvxtu.supabase.co/storage/v1/object/public/contents/prod/react-query-post/1.png?t=2024-08-02T14%3A39%3A20.396Z)

> useQuery의 구조

### Key

![키](https://lnwblzacktgzeiihvxtu.supabase.co/storage/v1/object/public/contents/prod/react-query-post/1.png?t=2024-08-02T14%3A39%3A20.396Z)
...
![스크린샷 2022-07-03 오후 11.38.12.png](https://lnwblzacktgzeiihvxtu.supabase.co/storage/v1/object/public/contents/prod/react-query-post/3.png?t=2024-08-02T14%3A39%3A32.342Z)
...
![스크린샷 2022-07-03 오후 11.54.34.png](https://lnwblzacktgzeiihvxtu.supabase.co/storage/v1/object/public/contents/prod/react-query-post/4.png?t=2024-08-02T14%3A39%3A37.455Z)
...
![제안하는 방식](https://lnwblzacktgzeiihvxtu.supabase.co/storage/v1/object/public/contents/prod/react-query-post/5.png?t=2024-08-02T14%3A39%3A43.535Z)
...
![스크린샷 2022-07-03 오후 4.30.16.png](https://lnwblzacktgzeiihvxtu.supabase.co/storage/v1/object/public/contents/prod/react-query-post/6.png?t=2024-08-02T14%3A39%3A50.919Z)

key-callback 조합은 현재의 Constant 관리방법처럼 매우 길어질 가능성이 있습니다. 이를 key tree로 만들 수 있을겁니다. 아래는 함수 하나 당 query key를 여러개 만드는 예시입니다.

![출처: react-query 메인테이너 블로그](https://lnwblzacktgzeiihvxtu.supabase.co/storage/v1/object/public/contents/prod/react-query-post/7.png?t=2024-08-02T14%3A39%3A56.516Z)
...
![스크린샷 2022-07-03 오후 5.12.39.png](https://lnwblzacktgzeiihvxtu.supabase.co/storage/v1/object/public/contents/prod/react-query-post/8.png?t=2024-08-02T14%3A40%3A01.164Z)

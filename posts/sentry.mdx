...
![센트리란 무엇인가?](https://lnwblzacktgzeiihvxtu.supabase.co/storage/v1/object/public/contents/prod/sentry/1.png?t=2024-08-02T14%3A53%3A17.513Z)
...
![기본 에러메시지 형태](https://lnwblzacktgzeiihvxtu.supabase.co/storage/v1/object/public/contents/prod/sentry/2.png?t=2024-08-02T14%3A53%3A27.034Z)
...
![기본 에러로 두면 보이는 센트리 로그 화면](https://lnwblzacktgzeiihvxtu.supabase.co/storage/v1/object/public/contents/prod/sentry/3.png?t=2024-08-02T14%3A53%3A41.671Z)
...
```tsx
import { AxiosError as AxiosErrorType, AxiosRequestConfig, AxiosResponse } from 'axios';
...
![이름과 메시지가 커스텀된 에러 로그](https://lnwblzacktgzeiihvxtu.supabase.co/storage/v1/object/public/contents/prod/sentry/4.png?t=2024-08-02T14%3A56%3A47.625Z)

이름과 메시지를 보시면 제가 던지는 객체 이름대로 설정된 것을 볼 수 있습니다.

![추가데이터](https://lnwblzacktgzeiihvxtu.supabase.co/storage/v1/object/public/contents/prod/sentry/5.png?t=2024-08-02T14%3A56%3A58.293Z)
